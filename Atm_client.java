...
public class Atm_client implements ActionListener
{
	...
	public Atm_client(String userid,String name)
	{
		...
		welcomelabel.setText("Welcome to our ATM");
...
class endpage
{
	...
	public endpage()
	{
		label.setText("Thank you for using our ATM services");
		...
		label2.setText("For more details contact support@abcbank.com");
		label3.setBounds(150,550,300,35);
		label3.setFont(new Font(null,Font.BOLD,18));
		label3.setText("TOLL FREE NO:1800 300 220");
		frame1.setTitle("ABC Bank");
		frame1.add(label);
		frame1.add(label2);
		frame1.add(label3);
